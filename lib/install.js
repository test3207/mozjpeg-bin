...
bin.run(['-version']).then(() => {
	...
	const sourceUrl = process.env.npm_config_mozjpeg_url || 'https://github.com/mozilla/mozjpeg/releases/download/v3.2/mozjpeg-3.2-release-source.tar.gz'
	binBuild.url(sourceUrl, [
		'autoreconf -fiv',
		cfg,
		`make -j${cpuNum}`,
